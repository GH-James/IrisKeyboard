...
const uint16_t alphaLayer[rows][cols + extraCols] PROGMEM= {{0x29, 0x35, 0xea, 0xe2, 0xe9, 0x3b, 0x3e, 0xb6, 0xcd, 0xb5, 0x46, 0x4c},
                                                {0xf4, 0x14, 0x1a, 0x08, 0x15, 0x17, 0x1c, 0x18, 0x0c, 0x12, 0x13, 0x31},
...
const uint16_t symbolLayer[rows][cols + extraCols] PROGMEM = {{0x3a, 0x3b, 0x3c, 0x3d, 0x3e, 0x3f, 0x40, 0x41, 0x42, 0x43, 0x44, 0x45},
                                                {0xf35, 0xf01e, 0x1f, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x2a},
                                                {0x2b, 0xf36, 0xf37, 0xf2f, 0xf30, 0xf1f, 0xf21, 0xf26, 0xf27, 0xf33, 0x33, 0xf23},
                                                {0x80, 0x38, 0xf2d, 0xf02f, 0x30, 0xf20, 0xf22, 0xf24, 0xf31, 0xf2e, 0xf25, 0xf3},
                                                {0x0, 0x0, 0x83, 0x2a, 0x81, 0xf0, 0xf2, 0x2c, 0x28, 0x86, 0x0, 0x0}
};

const uint16_t numLayer[rows][cols + extraCols] PROGMEM = {{0x29, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
                                            {0x00, 0x4b, 0xf26, 0x52, 0x27, 0x4a, 0x54, 0x5f, 0x60, 0x61, 0x56, 0x00},
                                            {0x2b, 0x4e, 0x50, 0x51, 0x4f, 0x4d, 0x62, 0x5c, 0x5d, 0x5e, 0x57, 0x00},
                                            {0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x55, 0x59, 0x5a, 0x5b, 0x67, 0x00},
                                            {0x0, 0x0, 0x83, 0x2a, 0x81, 0xf1, 0xf0, 0x2c, 0x28, 0x86, 0x0, 0x0}
};

const uint16_t mouseLayer[rows][cols + extraCols] PROGMEM = {{0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00},
                                                {0xf4, 0x00, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x07, 0x00, 0x00, 0x00},
...
const uint16_t gameLayer[rows][cols + extraCols] PROGMEM = {{0x29, 0x1e, 0x1f, 0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27, 0x2a},
                                              {0xf0, 0x14, 0x1a, 0x08, 0x15, 0x17, 0x1c, 0x18, 0x0c, 0x12, 0x13, 0x31},
                                              {0x81, 0x04, 0x16, 0x07, 0x09, 0x0a, 0x0b, 0x0d, 0x0e, 0x0f, 0x33, 0x34},
                                              {0x80, 0x1d, 0x1b, 0x06, 0x05, 0x05, 0x11, 0x10, 0x36, 0x37, 0x38, 0xf3},
                                              {0x00, 0x00, 0x83, 0x2c, 0x2c, 0xf2, 0xf2, 0x2c, 0x28, 0x86, 0x00, 0x00}
};
